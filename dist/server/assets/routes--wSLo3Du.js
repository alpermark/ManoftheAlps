...
}))), "batch03-p24", "batch06-p62"), "batch03-p48", 130), "batch09-p37", 20);
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "relative flex flex-col items-start max-w-[92vw] max-h-[86vh]",
					onClick: (e) => e.stopPropagation(),
					children: [magnifyActive ? /* @__PURE__ */ jsx("p", {
						className: "mb-2 text-red-500 pointer-events-none",
						"aria-hidden": true,
						...
						className: "interactive-target mb-2 text-white/70 hover:text-white transition-colors",
						"data-cursor": "Magnify",
						children: /* @__PURE__ */ jsx(ZoomIn, {
							size: 20,
							strokeWidth: 1.5
						...
						children: [/* @__PURE__ */ jsx("img", {
							...
							className: `max-w-[92vw] max-h-[calc(86vh-2rem)] w-auto h-auto object-contain ${magnifyActive ? "cursor-none" : "cursor-zoom-out"}`,
							"data-cursor": magnifyActive ? void 0 : "Close"
						}), magnifyActive && lens && /* @__PURE__ */ jsx("div", {
							"aria-hidden": true,
			...
			photos.length > 1 && !magnifyActive && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("button", {
				type: "button",
				onClick: (e) => {
					e.stopPropagation();
					go(-1);
