...
var styles_default = "/assets/styles-CiUJYbiB.css";
//#endregion
...
var SITE_TITLE = "Mark Alper | Man of the Alps";
var SITE_DESCRIPTION = "Travel photography by Mark Alper, Man of the Alps. An ongoing archive of images from cities, roads, nature, and the strangers that move between them—kept and added to slowly.";
var OG_DESCRIPTION = SITE_DESCRIPTION;
	...
	head: () => ({
		meta: [
			...
			},
			{
				...
				content: "Mark Alper | Man of the Alps"
			},
			{
				name: "twitter:card",
				content: "summary"
...
var $$splitComponentImporter = () => import("./routes-B6lwZ92q.js");
var Route = createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "Mark Alper | Man of the Alps" },
		{
			name: "description",
			content: "Travel photography by Mark Alper, Man of the Alps. An ongoing archive of images from cities, roads, nature, and the strangers that move between them—kept and added to slowly."
		},
		{
			property: "og:title",
			content: "Mark Alper | Man of the Alps"
