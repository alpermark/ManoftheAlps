...
function Lightbox({ photos, index, onIndexChange, onClose, getRect }) {
	...
	useEffect(() => {
		...
		const onTouchEnd = () => {
			...
			if (!nav.moved && tapOnImage) closeRef.current();
		};
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							photos.length > 1 && !magnifyActive && /* @__PURE__ */ jsx("button", {
								type: "button",
								onClick: (e) => {
									e.stopPropagation();
									go(-1);
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("img", {
									...
									className: `w-auto h-auto object-contain touch-manipulation ${photos.length > 1 && !magnifyActive ? "max-w-[min(92vw,calc(100vw-10.5rem))] max-h-[calc(86vh-5.5rem)]" : "max-w-[92vw] max-h-[calc(86vh-5.5rem)]"} ${magnifyActive ? "cursor-none" : "cursor-zoom-out"}`,
									"data-cursor": magnifyActive ? void 0 : "Close"
